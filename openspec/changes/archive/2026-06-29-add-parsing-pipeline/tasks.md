...
- [x] 1.2 Run the new tests before implementation and save real RED evidence to `openspec/changes/archive/2026-06-29-add-parsing-pipeline/evidence/red-run.json`.
...
- [x] 3.1 Run GREEN tests and save `openspec/changes/archive/2026-06-29-add-parsing-pipeline/evidence/green-run.json`.
