...
| 2026-06-29-add-bank-statement-imports | clean | 7 linked | **0** | yes | - |
...
- **trailer**: 2026-06-29-add-bank-statement-imports: no commit carries a "Slice: add-bank-statement-imports" trailer
